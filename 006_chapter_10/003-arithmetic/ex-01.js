...
console.log(`Частное: ${x / y}`); // Частное: 2 - обычное деление
console.log(`Частное: ${10 / 4}`); // Частное: 2.5
console.log(`Остаток: ${x % y}`); // Остаток: 0 - остаток от деления
console.log(`Остаток: ${10 % 4}`); // Остаток: 2

// Часть 2: Операторы и приоритет операций
let a = 9;
let b = 2;
console.log(`Порядок операций: ${(2 + a) * b}`); // Порядок операций: 22
...
num /= 10;
console.log(`Присваивание с делением: ${num}`); // Присваивание с умножением: 2.4
